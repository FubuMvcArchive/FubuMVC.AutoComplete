...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.AutoComplete"
COPYRIGHT = 'Copyright 2012 FubuMVC.AutoComplete. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  bottles("assembly-pak src/FubuMVC.AutoComplete -p FubuMVC.AutoComplete.csproj")

  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.AutoComplete.sln', :clrversion => CLR_TOOLS_VERSION
